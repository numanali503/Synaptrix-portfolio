...
function Footer() {
  return (
    <div className="relative overflow-hidden">
      <div
        aria-hidden="true"
        className="absolute -bottom-36 left-1/2 -translate-x-1/2 flex z-[-1]"
      >
        ...
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
              <img class="w-auto h-9" src={logo} alt="err" className="w-72" />

              <p class="text-base leading-relaxed text-gray-600 mt-7">
                Delivering Tailored & Intutive IT Solutions to Transform your
              ...
              <ul class="flex items-center space-x-3 mt-9">
                ...
                <li>
                  <Link
                    to="https://github.com/Synaptrix-Dev"
            ...
            <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
              ...
              <p className="text-base text-gray-600 mt-2">
                Mustafabad, Sargodha Road, Faisalabad 38000, Punjab Pakistan
              </p>
              <p className="text-base font-semibold text-black mt-3">
                Phone: <span className="font-normal">+92 343 2629294</span>
              </p>
              <p className="text-base font-semibold text-black mt-3">
                Email:{" "}
                <span className="font-normal">info@synaptrixsol.com</span>
              </p>
            </div>
          </div>
          ...
          <p class="text-sm text-center text-gray-600">
            © Copyright 2025, All Rights Reserved by Synaptrix Solution
          </p>
        </div>
      </section>
    </div>
