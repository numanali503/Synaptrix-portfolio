            ...
            <div className="relative overflow-hidden py-20 flex items-center justify-center">
                ...
                <div className="relative z-10 max-w-[80rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-32 text-center">
                    <div class="flex items-center justify-center w-full flex-wrap gap-4">
                        ...
                        <Link class="inline-block text- font-medium tracking-tight bg-clip-text bg-gradient-to-l from-blue-600 to-violet-500 text-transparent" href="/products/dms">       UI / UX Designing</Link>
                    </div>
                    ...
                    <div className="mt-12 space-y-12 w-full">
                        <div class="flex w-full">
                            <div class="w-1/3 flex items-center relative">
                                ...
                                <span class="font-bold text-2xl text-blue-600 ml- relative z-10">In-Depth Discovery</span>
                            </div>
                            <div class="w-2/3 py-2 px-6 ml-6 border-l-2 border-slate-300">
                                <p class="text-gray-600 text-xl">
                                    Immersing ourselves in your brand, target audience, and objectives to tailor designs that authentically represent your vision.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex w-full">
                            <div class="w-1/3 flex items-center relative">
                                ...
                                <span class="font-bold text-2xl text-blue-600 relative z-10">Collaborative Ideation</span>
                            </div>
                            <div class="w-2/3 py-2 px-6 ml-6 border-l-2 border-slate-300">
                                <p class="text-gray-600 text-xl">
                                    Emphasizing collaboration with you throughout the process to ensure the final design aligns perfectly with your aspirations and goals.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex w-full">
                            <div class="w-1/3 flex items-center relative">
                                ...
                                <span class="font-bold text-2xl text-blue-600  relative z-10">Strategic Visuals</span>
                            </div>
                            <div class="w-2/3 py-2 px-6 ml-6 border-l-2 border-slate-300">
                                <p class="text-gray-600 text-xl">
                                    Combining artistic flair with a strategic mindset when creating visuals, whether to convey emotions, showcase products, or create brand recognition.
                        ...
                        <div class="flex w-full">
                            <div class="w-1/3 flex items-center relative">
                                ...
                                <span class="font-bold text-2xl text-blue-600  relative z-10">Attention to Detail</span>
                            </div>
                            <div class="w-2/3 py-2 px-6 ml-6 border-l-2 border-slate-300">
                                <p class="text-gray-600 text-xl">
                                    We're meticulous about every aspect. Our dedicated focus on typography, color selection, composition, and aesthetics ensures a captivating and visually appealing design.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-12 space-y-12 w-full">
                    <div className='flex flex-wrap justify-center gap-4 mt-16 max-w-6xl mx-auto'>
                        <div className='text-primary text-xl font-semibold bg-slate-50 border boder-slate-100 py-4 px-8 rounded-xl'>
                            <img src="https://www.svgrepo.com/show/452151/adobe-xd.svg" alt="err" className="w-32" />
                        </div>
                        <div className='text-primary text-xl font-semibold bg-slate-50 border boder-slate-100 py-4 px-8 rounded-xl'>
                            <img src="https://www.svgrepo.com/show/452149/adobe-photoshop.svg" alt="err" className="w-32" />
                        </div>
                        <div className='text-primary text-xl font-semibold bg-slate-50 border boder-slate-100 py-4 px-8 rounded-xl'>
                            <img src="https://www.svgrepo.com/show/452147/adobe-illustrator.svg" alt="err" className="w-32" />
                        </div>
                        <div className='text-primary text-xl font-semibold bg-slate-50 border boder-slate-100 py-4 px-8 rounded-xl'>
                            <img src="https://www.svgrepo.com/show/448222/figma.svg" alt="err" className="w-32" />
                        </div>
                        <div className='text-primary text-xl font-semibold bg-slate-50 border boder-slate-100 py-4 px-8 rounded-xl'>
                            <img src="https://www.svgrepo.com/show/341669/canva.svg" alt="err" className="w-32" />
                        </div>
                    </div>
                </div>
            </div>
