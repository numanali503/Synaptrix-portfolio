  ...
  return (
    <div className="relative overflow-hidden py-24 flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-[80rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-32 text-center">
        ...
        <p className="mt-12 text-gray-600 px-12">
          We specialize in delivering top-notch services across multiple
          domains, ensuring that your digital endeavors reach their full
          potential. Explore our specialized services in website development,
          mobile app development, and UI/UX design.
        </p>
        <div className="flex justify-center">
          <Link
            to="/contact"
            className="relative mt-4 rounded-lg border-2 border-blue-700 bg-primary px-12 py-4 font- text-white transition hover:translate-y-1"
          >
