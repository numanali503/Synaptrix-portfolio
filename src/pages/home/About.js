...
function About() {
  return (
    <div className="bg-gradient-to-tl from-blue-100 to-violet-100 py-10 md:py-20">
      <div className="max-w-[80rem] px-4 sm:px-6 md:px-8 mx-auto flex flex-col md:flex-row items-center md:items-start justify-center gap-8 md:gap-0">
        <div className="w-full md:w-1/2 text-center md:text-left">
          <h1 className="mt-5 text-2xl sm:text-4xl md:text-3xl lg:text-6xl font-light text-primary">
            <span className="relative inline-block">
              ...
              <img src={under} alt="underline" className="absolute" />
            </span>
          </h1>
          <h1 className="text-gray-600 pt-6 text-sm sm:text-base md:text-base">
            Synatrix is a renowned digital development company that offers
            software development services for businesses, startups, and
            enterprises. We specialize in developing innovative solutions and
            providing world-class engineers to help leading tech innovators in
            building successful software.
          </h1>
          <Link
            to="/about"
            className="relative mt-4 rounded-lg border-2 border-blue-700 bg-primary px-6 py-2 font-medium text-white transition hover:translate-y-1 inline-block"
          >
